    ...
    return (
        <>
            <div className={styles.footerMenu}>
                <ul className={styles.footerMenunav}>
                    <li className={styles.footerMenunav__item}>
                        <a
                            className={styles.footerMenunav__link}
                    ...
                    <li className={styles.footerMenunav__item}>
                        <a
                            className={styles.footerMenunav__link}
                            href="https://pocketoption.com/en/privacy-policy/"
                        >
                            Privacy Policy
                        </a>
                    </li>
                    <li className={styles.footerMenunav__item}>
                        <a
                            className={styles.footerMenunav__link}
                            href="https://pocketoption.com/en/responsibility-disclosure/"
                        >
